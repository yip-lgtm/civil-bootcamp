...
|---|---|---|---|
| Sensing | Sensing | Core definition | 核心定義 |
| IoT | IoT | Application | 應用 |
| Signal processing | Signal processing | Limitation | 限制 |
| Mathematical formulation | 數學形式 | Key equation | 關鍵方程 |

### 1.2 Key Derivation

For Sensing and Intelligent Systems, the fundamental relationships are:
$$f(x) = \text{key equation}, \quad x = \text{variable}$$

This arises from Sensing applied to the engineering system.
...
```mermaid
mindmap
    root((Sensing and Intelligent Systems))
      Core
        Concepts
      Methods
        Analytical
...
1. **Core concepts** — Sensing 嘅 foundation
...
## 1. Sensing — Core concept

### 1.1 Three-process physical essence
For Sensing and Intelligent Systems, Sensing governs the system behavior. Description of Sensing with bilingual explanation.
...
## 3. Signal processing — Analysis techniques
...
**Q1.** Derive core relationship for Sensing and Intelligent Systems.
**Answer:** Starting from definitions, derive the key equation. Verify units and limits.
