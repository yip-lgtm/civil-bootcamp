# Track 3 — Energy, Transportation & Societal Systems (Systems)
**MIT CEE Core | 54–66 Units (CORE) + 48–60 Units (REs)**

---

The **Systems Engineering** track (page title: "Energy, Transportation, and
Societal Systems Track") focuses on mathematical methods — network science,
optimization, control theory, and data analytics — applied to urban systems
like transportation, supply chains, energy, water, and societal networks.

The MIT page shows two main **focus** sub-areas within Systems:
...
|---|---|---|
| [Transportation and Urban Systems](./Transportation_Urban_Systems/) | Networks, transportation, sustainability, water | 5 courses |
| [Energy Systems](./Energy_Systems/) | *(placeholder — to be expanded)* | — |

## Required CORE (per MIT CEE brochure 2023 + Systems Engineering page)

| Course | Title | Units | File |
|---|---|---|---|
| 1.020 | Engineering Sustainability: Analysis and Design | 12 | [Transportation_Urban_Systems/02_1.020_Engineering_Sustainability.md](./Transportation_Urban_Systems/02_1.020_Engineering_Sustainability.md) |
| 1.022 | Introduction to Network Models | 12 | [Transportation_Urban_Systems/05_1.022_Introduction_to_Network_Models.md](./Transportation_Urban_Systems/05_1.022_Introduction_to_Network_Models.md) |
| 1.041 | Transportation: Foundations and Methods | 12 | [Transportation_Urban_Systems/01_1.041_1.022_Transportation_Networks.md](./Transportation_Urban_Systems/01_1.041_1.022_Transportation_Networks.md) |
| 1.075 | Water Resource Systems | 12 | [Transportation_Urban_Systems/03_1.075_Water_Resource_Systems.md](./Transportation_Urban_Systems/03_1.075_Water_Resource_Systems.md) |
| 1.102 | Introduction to CEE Design II | 6 | [Transportation_Urban_Systems/04_1.102_Introduction_to_CEE_Design_II.md](./Transportation_Urban_Systems/04_1.102_Introduction_to_CEE_Design_II.md) |

> **Note:** The combined file `01_1.041_1.022_Transportation_Networks.md`
> covers both 1.041 and 1.022 — the new `05_1.022_Introduction_to_Network_Models.md`
> is a more focused 1.022 stub that can be expanded later.

## Course list (current repo)

### Transportation and Urban Systems
- [01_1.041_1.022_Transportation_Networks.md](./Transportation_Urban_Systems/01_1.041_1.022_Transportation_Networks.md) — *stub (combined 1.041+1.022)*
- [02_1.020_Engineering_Sustainability.md](./Transportation_Urban_Systems/02_1.020_Engineering_Sustainability.md) — *stub*
- [03_1.075_Water_Resource_Systems.md](./Transportation_Urban_Systems/03_1.075_Water_Resource_Systems.md) — *stub*
- [04_1.102_Introduction_to_CEE_Design_II.md](./Transportation_Urban_Systems/04_1.102_Introduction_to_CEE_Design_II.md) — *stub (just added)*
- [05_1.022_Introduction_to_Network_Models.md](./Transportation_Urban_Systems/05_1.022_Introduction_to_Network_Models.md) — *stub (just added)*
...
1. **Year 3:** 1.041 (Transportation Foundations) + 1.020 (Sustainability)
2. **Year 3:** 1.022 (Network Models) — the analytical foundation
3. **Year 3:** 1.074 (Data Analysis) — supporting GDR
4. **Year 4:** 1.075 (Water Resource Systems) + 1.102 (CEE Design II)
5. **Post-grad:** MEng in Systems Engineering, or supply chain / transportation / data science roles
