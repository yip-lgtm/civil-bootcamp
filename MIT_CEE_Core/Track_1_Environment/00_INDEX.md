...
sub-areas (each is a "focus" in the MIT CEE page):
...
## Recommended First-Year (per MIT CEE page)

- **1.009 Climate Change** (Fall) — strongly recommended for the atmospheric-chemistry focus

## Course List (Current Repo Status)

### Environmental Life Sciences
- [01_1.063_Fluids_and_Disease.md](./Environmental_Life_Sciences/01_1.063_Fluids_and_Disease.md) — *expanded (Lydia Bourouiba; fluid dynamics of disease transmission; 29227 bytes)*
- [02_1.081_Environmental_Cancer_Risks.md](./Environmental_Life_Sciences/02_1.081_Environmental_Cancer_Risks.md) — *stub*
- [03_1.088_Genomics_Evolution_of_Infectious_Disease.md](./Environmental_Life_Sciences/03_1.088_Genomics_Evolution_of_Infectious_Disease.md) — *expanded*
- [04_1.089_Earths_Microbiomes.md](./Environmental_Life_Sciences/04_1.089_Earths_Microbiomes.md) — *expanded*
- [05_20.507_Introduction_to_Biological_Chemistry.md](./Environmental_Life_Sciences/05_20.507_Introduction_to_Biological_Chemistry.md) — *expanded*
- [06_7.102_Introduction_to_Molecular_Biology_Techniques.md](./Environmental_Life_Sciences/06_7.102_Introduction_to_Molecular_Biology_Techniques.md) — *expanded*
- [07_12.715_Environmental_Bioinformatics.md](./Environmental_Life_Sciences/07_12.715_Environmental_Bioinformatics.md) — *expanded*

### Fluids and Transport Engineering
- [00_1.009_Climate_Change.md](./Fluids_Transport_Engineering/00_1.009_Climate_Change.md) — *stub*
...
- [06_1.107_Water_and_Air_Quality_Laboratory.md](./Fluids_Transport_Engineering/06_1.107_Water_and_Air_Quality_Laboratory.md) — *stub (renamed)*

## Self-Study Path

1. **Year 1 Fall:** 1.009 Climate Change (recommended first-year)
2. **Year 2:** GIRs — Biology, Chemistry, Physics I/II (foundation)
3. **Year 3:** 1.061 (Transport Processes) — the foundational environmental engineering subject
4. **Year 3:** Pair 1.061 with 1.080 (Environmental Chemistry) for the atmospheric focus
5. **Year 3:** Pair with 1.018/1.070 (Ecology/Hydrology) for the hydrology focus
6. **Year 3:** Take 1.106 + 1.107 labs alongside theory
7. **Summer between Y3/Y4:** Apply for TREX (1.091) — field experience in Italy or the field
8. **Year 4:** 1.063 + 1.081 for the microbiology/public-health angle
9. **Post-grad:** M.Eng in Environmental Engineering, or PhD in environmental science/engineering

## Core Faculty (Track 1)

| Professor | Research area | Key courses |
|---|---|---|
| Prof. Lydia Bourouiba | Fluid dynamics of disease transmission | 1.063 Fluids & Disease |
| Prof. [various] | Atmospheric chemistry, climate | 1.009, 1.080 |
| Prof. [various] | Hydrology, water resources | 1.018/1.070, 1.106/1.107 |
