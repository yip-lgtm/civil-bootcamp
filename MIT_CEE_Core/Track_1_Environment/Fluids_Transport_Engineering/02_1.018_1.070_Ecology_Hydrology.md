...
## 1. Ecology — Core concept

### 1.1 Three-process physical essence
For Fundamentals of Ecology + 1.070A Hydrology (Environmental Track), Ecology governs the system behavior. Description of Ecology with bilingual explanation.
...
## 3. Energy flow — Analysis techniques
...
**Q1.** Derive core relationship for Fundamentals of Ecology + 1.070A Hydrology (Environmental Track).
...
```mermaid
mindmap
    root((Fundamentals of Ecology + 1.070A Hydrology (Environmental Track)))
      Core
        Concepts
      Methods
        Analytical
...
1. **Core concepts** — Ecology 嘅 foundation
