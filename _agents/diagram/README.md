...
- ✅ **必須**: 至少 1 個 diagram 包含 course-specific entities (e.g., 液滴 → Wells curve)
...
stateDiagram-v2
    [*] --> Idle
    Idle --> Emission: cough
    Emission --> Cloud: turbulent puff
    Cloud --> Settling: gravity
    Cloud --> Inhalation: <2m
    Settling --> [*]
    Inhalation --> Infection: dose>ID50
    Infection --> [*]
```
