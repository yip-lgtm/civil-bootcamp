...
> Environmental Data Analysis" (environmental focus); 1.074 is "Multivariate Data
...
|---|---|---|
| [18.03_Differential_Equations.md](./18.03_Differential_Equations.md) | 18.03 | ODEs, Laplace transforms, Fourier series |
| [1.000_Introduction_to_Computer_Programming_and_Numerical_Methods.md](./1.000_Introduction_to_Computer_Programming_and_Numerical_Methods.md) | 1.000 | Python, numerical methods, FEA |
| [1.010A_Probability_Concepts_and_Applications.md](./1.010A_Probability_Concepts_and_Applications.md) | 1.010A | Probability, random variables, statistics |
| [1.073_Introduction_to_Environmental_Data_Analysis.md](./1.073_Introduction_to_Environmental_Data_Analysis.md) | 1.073 | Environmental data, time series |
| [1.074_Multivariate_Data_Analysis.md](./1.074_Multivariate_Data_Analysis.md) | 1.074 | PCA, regression, multivariate stats |
| [1.101_Introduction_to_CEE_Design.md](./1.101_Introduction_to_CEE_Design.md) | 1.101 | CEE design process, sustainability |
| [1.013_Senior_CEE_Design_Capstone.md](./1.013_Senior_CEE_Design_Capstone.md) | 1.013 | Capstone design project |

## Self-Study Path

1. **Year 1–2:** Complete GIRs (parallel with GDRs)
...
> **Tip:** 18.03, 1.000, 1.010A, 1.074 are prerequisites for nearly every upper-division CEE course. Completing them in Year 2 maximizes scheduling flexibility.
